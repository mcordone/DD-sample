...
package com.aol.advertising.dealdiscovery.forecast.lambda.deals;

import com.amazonaws.services.lambda.runtime.Context;
import com.amazonaws.services.lambda.runtime.LambdaLogger;
import com.aol.advertising.dealdiscovery.forecast.application.AppConfig;
import com.aol.advertising.dealdiscovery.forecast.service.DealsService;
...
public class ForecastLambdaProd {
    ...
    public int handleRequest(Map<String, Object> input, Context context) {
        ...
        //get service
        DealsService service = applicationContext.getBean(DealsService.class);

        //Start ETL job
        jestResult = service.generateLanaDealData();
